/*
    With a heavy heart im removing this code from my app, i spent months working around this Video Screen but at the
    end of the this is pretty useless, the fact is users want to see video/audio/photo whatever based on the apps they
    already have, so this is of no use and increases the size of our application for no good reason.

    You wiil be remembered by me VideoPlayer StackScreen
    "react-native-video": "^5.2.0",


    This file will be deleted in next commit.
*/
